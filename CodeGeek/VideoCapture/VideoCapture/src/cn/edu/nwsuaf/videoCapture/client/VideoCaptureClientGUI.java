 ...
 * 
 */
public class VideoCaptureClientGUI extends JFrame implements ActionListener {
	 ...
	 */
	public VideoCaptureClientGUI() throws HeadlessException {
		super();
	...
	public void sendMessage() {
		...
		if (clientSocket == null || clientSocket.isClosed()) {
			...
			if (message == null || message.trim().equals("")) {
				...
				new UDPTransmit(clientSocket, "6#" + message, serverAddress,
						serverPort, false).start();
