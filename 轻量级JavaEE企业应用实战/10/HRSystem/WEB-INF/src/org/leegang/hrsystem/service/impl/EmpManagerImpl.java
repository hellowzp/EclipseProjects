package org.leegang.hrsystem.service.impl;
...
import org.leegang.hrsystem.service.*;
...
public class EmpManagerImpl implements EmpManager
{
	...
	{
		//如果找到一个经理，以经理登录
		if (mgrDao.findByNameAndPass(user,pass).size()
			>= 1)
		{
			return LOGIN_MGR;
		}
